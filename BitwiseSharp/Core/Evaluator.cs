...
{
    /// <summary>
    /// Evaluates an AST generated by the <see cref="Parser"/> using recursive tree-walking.
    /// </summary>
    internal class Evaluator
    {
        private readonly EnvironmentContext _environmentContext;

        /// <summary>Initializes an instance of the <see cref="Evaluator"/> class.</summary>
        /// <param name="environmentContext">The environment context of the evaluator that provides its symbol table.</param>
        ...
        /// <summary>
        /// Evaluates an AST <see cref="Node"/> recursively.
        /// </summary>
        /// <param name="node">The AST node to evaluate.</param>
        /// <returns>
        /// A <see cref="Result{ArbitraryNumber}"/> representing the outcome of the evaluation. 
        /// If successful, the result contains the evaluated <see cref="ArbitraryNumber"/>. 
        /// If there is an error (e.g., undefined variable or invalid operator), the result contains
        /// a failure message.
        /// </returns>
